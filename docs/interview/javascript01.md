...
本文章摘自掘金
作者：CUGGZ
链接：[掘金原文](https://juejin.cn/post/6940945178899251230)
:::

![JavaScript面试题.png](./javascript.assets/fc9240467b46494ca8fdc2d35d9f729e~tplv-k3u1fbpfcp-watermark.png)
...
下面看一下**双精度数是如何保存**的： ![img](./javascript.assets/0cb225cf71d748a8b2d6a5615e402711~tplv-k3u1fbpfcp-zoom-1.png)
...
其流程图如下： ![img](./javascript.assets/c451c19e23dd4726b3f36223b6c18a1e~tplv-k3u1fbpfcp-zoom-1.png)
...
最终，a、b、c分别被赋予了数组第0、1、2个索引位的值： ![img](./javascript.assets/e55fc36b191340e69698782fbd67ef4f~tplv-k3u1fbpfcp-zoom-1.png) 数组里的0、1、2索引位的元素值，精准地被映射到了左侧的第0、1、2个变量里去，这就是数组解构的工作模式。还可以通过给左侧变量数组设置空占位的方式，实现对数组中某几个元素的精准提取：
...
通过把中间位留空，可以顺利地把数组第一位和最后一位的值赋给 a、c 两个变量： ![img](./javascript.assets/a14ffbb3df2646a4a84f4a0c7d62d975~tplv-k3u1fbpfcp-zoom-1.png)
...
这样就得到了 name 和 age 两个和 stu 平级的变量： ![img](./javascript.assets/1ed2565845f2415b8243c8c355b2c6d6~tplv-k3u1fbpfcp-zoom-1.png)
