...
![img](./javascript.assets/40194bdc07024b78b6da8bb43d84a7d8~tplv-k3u1fbpfcp-zoom-1.png) func1的运行结果其实就是一个Promise对象。因此也可以使用then来处理后续逻辑。
...
![img](./javascript.assets/507e439801c043739c4667567e5f8562~tplv-k3u1fbpfcp-zoom-1.png)
